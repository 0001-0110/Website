...
?>
<?php
$metaGeneratorContent = 'Nicepage 4.6.5, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    ...
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-2957">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/logo-16.png",
            'default_url' => "[page_163804757]"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="830" data-image-height="577" title="Home">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-727f-29',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-727f-30',
                    'submenu_item_class' => 'u-nav-item',
    ...
    <div class="u-social-icons u-spacing-10 u-social-icons-1">
      <a class="u-social-url" title="facebook" target="_blank" href="https://facebook.com/name"><span class="u-file-icon u-icon u-social-facebook u-social-icon u-icon-1"><img src="<?php echo get_template_directory_uri(); ?>/images/5968756.png" alt=""></span>
      </a>
    </div>
  </div>
</header>
