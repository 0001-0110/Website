...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://facebook.com/name"));
    ...
    $logo = theme_get_logo(array('default_src' => "/images/logo-16.png", 'default_url' => ''));
    if (!empty($logo['src'])) {
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#834496');
